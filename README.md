...
- ruamel-yaml: 
- tomlkit: 
- wexample-config: >=6.1.0
- wexample-event: >=0.0.80
- wexample-file: >=0.0.53
- wexample-helpers-yaml: >=0.1.0
...
- python-dotenv: 
- tomlkit: 
- wexample-config: >=0.3.0
- wexample-event: >=0.0.80
- wexample-file: >=0.0.53
- wexample-helpers-yaml: >=0.0.114
...
- **PyPI**: [pypi.org/project/filestate](https://pypi.org/project/filestate/)
