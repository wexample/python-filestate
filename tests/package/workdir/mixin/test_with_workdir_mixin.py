...
class TestWithWorkdirMixin(AbstractWorkdirMixinTest):
    ...
    def test_workdir_mixin_instantiation(self, tmp_path) -> None:
        ...
        assert hasattr(instance, 'workdir'), "WithWorkdirMixin should provide workdir property"
        assert hasattr(instance, 'host_workdir'), "WithWorkdirMixin should provide host_workdir property"
