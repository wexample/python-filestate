...
from wexample_filestate.testing.abstract_content_file_test import AbstractContentFileTest
...
class TestHtmlFile(AbstractContentFileTest):
    ...
    def _validate_loaded_content(self, raw_content: str, loaded_content: Any) -> None:
        ...
        assert loaded_content == raw_content, "Loads should return the original content unchanged"
