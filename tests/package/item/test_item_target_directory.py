...
class TestItemTargetDirectory(AbstractStateManagerTest):
    ...
    def _create_directory_item(self, tmp_path: Path) -> ItemTargetDirectory:
        ...
        if children_configs:
            directory.set_value({
                ChildrenOption.get_name(): children_configs
            })
    ...
    def _configure_subdirectories_recursively(self, directory: ItemTargetDirectory) -> None:
    ...
    def test_find_by_path_recursive(self, tmp_path) -> None:
        """Test find_by_path_recursive() method."""
        self._setup_with_tmp_path(tmp_path)
    ...
    def test_for_each_child_of_type(self, tmp_path) -> None:
        ...
        for item in files_found:
            ...
            assert isinstance(item, ItemTargetFile), "All items should be ItemTargetFile"
        ...
        for item in dirs_found:
            ...
            assert isinstance(item, ItemTargetDirectory), "All items should be ItemTargetDirectory"
    ...
    def test_for_each_child_recursive(self, tmp_path) -> None:
        ...
        assert any("subsubdir" in path for path in item_paths), "Should traverse subsubdir"
