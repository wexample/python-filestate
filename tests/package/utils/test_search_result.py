...
class TestSearchResult(AbstractStateManagerTest):
    ...
    def test_create_for_all_matches_literal(self, tmp_path) -> None:
        ...
        assert len(results) == 1, "Case-sensitive literal search should find 1 'hello' match"
    ...
    def test_create_for_all_matches_regex(self, tmp_path) -> None:
        ...
        assert actual_lines == expected_lines, f"Expected lines {expected_lines}, got {actual_lines}"
    ...
    def test_create_for_all_matches_word_boundary(self, tmp_path) -> None:
        ...
        for result in results:
            ...
            assert 'hello_function' not in line_content or 'hello' in line_content.split(), \
    ...
    def test_create_one_if_match_regex(self, tmp_path) -> None:
        ...
        assert "def hello_function" in item.read_text().split('\n')[0], \
    ...
    def test_deprecated_create_if_match(self, tmp_path) -> None:
        ...
        assert result.line == new_result.line, "Deprecated method should match new method"
        assert result.column == new_result.column, "Deprecated method should match new method"
